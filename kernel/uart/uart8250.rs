...
#[inline(never)]
pub fn init_uart_8250(addr: *mut u8) -> Result<&'static SpinMutex<Uart>, UartInitError> {
    let uart = UART8250.try_call_once(|| Uart::from_ptr(addr));
...
impl KSay for Uart  {
    const NAME: &'static str = "uart8250";
}
